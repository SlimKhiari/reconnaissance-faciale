...
<body>
      ...
      <section class="section about-me">
            ...
            <span><p style="font-size:21px;">Ce site web intranet est destine a la scolarite pour consulter l'assiduite des etudiants avec leurs informations, aussi il permet de visualiser la liste des visiteurs avec leurs coordonnees .</p></span>
          </div>
