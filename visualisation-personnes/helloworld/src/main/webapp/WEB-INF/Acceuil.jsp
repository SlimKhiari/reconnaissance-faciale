...
<body>
      ...
      <section class="section about-me">
            ...
            <span><p style="font-size:21px;">Ce site web intranet est destiné a la scolarité pour consulter l'assiduité des étudiants avec leurs informations, aussi il permet de visualiser la liste des visiteurs avec leurs coordonnées .</p></span>
          </div>
