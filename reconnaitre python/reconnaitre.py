...
try :
	connexion_base_de_donnees = mysql.connector.connect(user='root', password='Slimetsalambo123&',host='localhost',database='reconnaissance',auth_plugin='mysql_native_password')
